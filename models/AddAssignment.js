...
addAssingment.belongsTo(Class, {
  foreignKey: "class_id",
  targetKey: "id",
  onDelete: "CASCADE",
});
addAssingment.belongsTo(section, {
  foreignKey: "section_id",
  targetKey: "id",
  onDelete: "CASCADE",
});
addAssingment.belongsTo(subject, {
  foreignKey: "subject_id",
  targetKey: "id",
  onDelete: "CASCADE",
});
addAssingment.belongsTo(subjectGroup, {
  foreignKey: "subject_group_id",
  targetKey: "id",
  onDelete: "CASCADE",
});
addAssingment.belongsTo(staff, {
