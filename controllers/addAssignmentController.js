...
exports.getUpcomingHomework = async (req, res, next) => {
  try {
    ...
    if (req.query.section_id) whereObj.section_id = req.body.query;

    if (req.query.subject_group_id)
      whereObj.subject_group_id = req.query.subject_group_id;

    if (req.query.subject_id) whereObj.subject_id = req.query.subject_id;
...
exports.createAssignment = async (req, res, next) => {
  try {
    upload(req, res, async (err) => {
      ...
      } else req.body.created_by_id = req.user.id;
